  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4">
      ...
      >
        ...
        <motion.h1
          className="mb-2 text-center text-6xl font-bold text-gray-800 select-none"
          initial={{ y: -20 }}
          animate={{ y: 0 }}
          transition={springConfig}
        >
        ...
        <motion.p
          className="mb-8 text-center text-xl text-gray-600 select-none"
          initial={{ y: 20 }}
          animate={{ y: 0 }}
      ...
      >
        <Link to="/">
          <motion.button
            className="bg-primary rounded-full px-6 py-3 text-lg font-semibold text-white shadow-lg select-none"
