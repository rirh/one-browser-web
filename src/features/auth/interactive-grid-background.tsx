    ...
    >
      ...
      <style>{`
        ...
        .dark .interactive-grid-background {
          ...
          --mask-size: clamp(200px, 24vw, 340px);
          --dot-base: color-mix(in oklch, var(--foreground) 12%, transparent);
          --dot-active: color-mix(in oklch, var(--primary) 54%, transparent);
          --base-opacity: 0.52;
          --active-opacity: 0.46;
          --mask-core-alpha: 88%;
          --mask-near-alpha: 70%;
