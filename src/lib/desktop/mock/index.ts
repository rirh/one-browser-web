...
import {
  ...
  mockPage,
  mockResult,
} from '@/lib/desktop/mock/app';
import {
  mockCreateProfile,
  mockDeleteProfiles,
  mockUpdateProfile,
  toProfileListItem,
} from '@/lib/desktop/mock/profiles';
import {
  mockCheckProxy,
  mockCreateProxy,
  mockDeleteProxies,
...
import { mustGet, toStringList } from '@/lib/desktop/mock/values';
import type { DesktopCommand, DesktopCommandArgs } from '@/lib/desktop/types';
